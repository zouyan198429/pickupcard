...
(function() {
   ...
   document.write("        if( item.status == 1 ){");
    ...
    document.write("            <td><%=item.activity_theme%><hr/><%=item.activity_subtitle%><\/td>");
    ...
    document.write("            <td><%=item.begin_num%><hr/><%=item.code_len%>位<\/td>");
    // document.write("            <td><\/td>");
    document.write("            <td><%=item.total_num%><hr/><%=item.used_num%><\/td>");
    // document.write("            <td><\/td>");
    // document.write("            <td><\/td>");
