...
class CityPartnerController extends BasicController
{
    public static $VIEW_NAME = 'cityPartner';// 视图栏目文件夹目录名称
...
//        }else{
//            $info = CTAPICityPartnerBusiness::getInfoData($request, $this, $id, [], '');
//            $this->isOwnSellerId($info);// 有企业id的记录，判断是不是当前企业
//        }
...
//        $this->appendSellerIdParams($mergeParams);
        CTAPICityPartnerBusiness::mergeRequest($request, $this, $mergeParams);
...
//        $mergeParams = ['ids' => $id];
//        CTAPICityPartnerBusiness::mergeRequest($request, $this, $mergeParams);
//        $dataList = CTAPICityPartnerBusiness::getList($request, $this, 1 + 0, [], [])['result']['data_list'] ?? [];
