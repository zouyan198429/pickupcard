...
//        $sort_num = CommonRequest::getInt($request, 'sort_num');
        ...
        $activity_theme = CommonRequest::get($request, 'activity_theme');
        $activity_subtitle = CommonRequest::get($request, 'activity_subtitle');
        $tag_price = CommonRequest::get($request, 'tag_price');
        $price = CommonRequest::get($request, 'price');
        $freight_price = CommonRequest::get($request, 'freight_price');
        $insured_price = CommonRequest::get($request, 'insured_price');
