...
//        $this->InitParams($request);
//        CTAPILabelsBusiness::importTemplate($request, $this);
//    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPILabelsBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPILabelsBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPILabelsBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
//    }
