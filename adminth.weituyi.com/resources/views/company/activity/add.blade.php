...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/company/activity/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('company/activity')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/company/lanmu/activity_edit.js') }}?3"  type="text/javascript"></script>
