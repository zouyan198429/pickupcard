...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/company/addrs/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('company/addrs')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/company/lanmu/addrs_edit.js') }}"  type="text/javascript"></script>
</body>
</html>
