...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/company/employee/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('company/employee')}}";//保存成功后跳转到的地址

    var SELECT_LATLNG_URL = "{{url('company/qqMaps/latLngSelect')}}";//选择经纬度的地址
...
<script src="{{ asset('/js/company/lanmu/employee_edit.js') }}"  type="text/javascript"></script>
</body>
</html>
