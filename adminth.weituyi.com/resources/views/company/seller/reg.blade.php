...
{{--    </div>--}}
  ...
  <script type="text/javascript">
      var SAVE_URL = "{{ url('api/company/ajax_reg') }}";// ajax保存记录地址
      var LIST_URL = "{{url('company')}}";// "{ {url('company/seller')}}";//保存成功后跳转到的地址
  ...
  <script src="{{ asset('/js/company/lanmu/seller_reg.js') }}?3"  type="text/javascript"></script>
</body>
</html>
