...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/company/seller/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('company/seller')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/company/lanmu/seller_edit.js') }}"  type="text/javascript"></script>
</body>
</html>
