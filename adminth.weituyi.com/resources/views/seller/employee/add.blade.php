...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/seller/employee/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('seller/employee')}}";//保存成功后跳转到的地址
...
<script src="{{ asset('/js/seller/lanmu/employee_edit.js') }}"  type="text/javascript"></script>
</body>
</html>
