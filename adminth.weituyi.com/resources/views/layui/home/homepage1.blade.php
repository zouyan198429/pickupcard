        ...
        <div class="layui-card">
          ...
          <div class="layui-card-body">
            <dl class="layuiadmin-card-status">
              <dd>
                <div class="layui-status-img"><a href="javascript:;"><img src="{{asset('layui-admin-v1.2.1/src/layuiadmin/style/res/logo.png')}}"></a></div>
                <div>
            ...
            <ul class="layui-row layuiadmin-card-team">
              <li class="layui-col-xs6">
                <a lay-href="https://www.layui.com/doc/modules/table.html">
                  <span class="layui-team-img"><img src="{{asset('layui-admin-v1.2.1/src/layuiadmin/style/res/logo.png')}}"></span>
                  <span>数据表格</span>
                </a>
              </li>
              <li class="layui-col-xs6">
