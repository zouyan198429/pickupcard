        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          ...
          <li class="layui-nav-item" lay-unselect>
            ...
            <dl class="layui-nav-child">
              <dd><a lay-href="{{ url('manage/info') }}">基本资料</a></dd>
              <dd><a lay-href="{{ url('manage/password') }}">修改密码</a></dd>
              <hr>
              <dd  style="text-align: center;"><a href="{{ url('manage/logout') }}">退出</a></dd>
            </dl>
          </li>
...
{{--                  @if(isset($baseArr['staff_id']) && $baseArr['staff_id'] == 1)--}}
                <dd>
                   <a lay-href="{{ url('manage/products') }}">商品管理</a>
                </dd>
                <dd>
                  <a lay-href="{{ url('manage/activity') }}">提货卡管理</a>
                </dd>
{{--                  @endif--}}
                <dd >
                  <a lay-href="{{ url('manage/addrs') }}">提货列表</a>
                </dd>
                  <dd >
                      <a lay-href="{{ url('manage/addrs_wait_send') }}">未发货列表</a>
                  </dd>
                  <dd >
                      <a lay-href="{{ url('manage/addrs_sended') }}">已发货列表</a>
                  </dd>
              </dl>
            </li>
...
{{--              @if(isset($baseArr['staff_id']) && $baseArr['staff_id'] == 1)--}}
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd>
                  <a lay-href="{{ url('manage/staff') }}">管理员列表</a>
                </dd>
              </dl>
                <dl class="layui-nav-child">
                    <dd>
                        <a lay-href="{{ url('manage/seller') }}">商家列表</a>
                    </dd>
                </dl>
                <dl class="layui-nav-child">
                    <dd>
                ...
                <dl class="layui-nav-child">
                    <dd>
                        <a lay-href="{{ url('manage/user') }}">用户列表</a>
                    </dd>
                </dl>
            </li>
{{--              @endif--}}
...
{{--                  @if(isset($baseArr['staff_id']) && $baseArr['staff_id'] == 1)--}}
                <dd class="layui-nav-itemed">
                  ...
                  <dl class="layui-nav-child">
                    <dd>
                      <a lay-href="{{ url('manage/city') }}">城市管理</a>
                    </dd>
                  </dl>
                </dd>
{{--                  @endif--}}
