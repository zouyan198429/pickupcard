...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/manage/codes/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('manage/codes')}}";//保存成功后跳转到的地址
</script>
<script src="{{ asset('/js/manage/lanmu/codes_edit.js') }}"  type="text/javascript"></script>
</body>
</html>
