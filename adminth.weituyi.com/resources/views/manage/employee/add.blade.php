...
<script type="text/javascript">
    var SAVE_URL = "{{ url('api/manage/employee/ajax_save') }}";// ajax保存记录地址
    var LIST_URL = "{{url('manage/employee')}}";//保存成功后跳转到的地址

    var SELECT_LATLNG_URL = "{{url('manage/qqMaps/latLngSelect')}}";//选择经纬度的地址
...
<script src="{{ asset('/js/manage/lanmu/employee_edit.js') }}"  type="text/javascript"></script>
</body>
</html>
