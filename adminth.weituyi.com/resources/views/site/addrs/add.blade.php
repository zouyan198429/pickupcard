...
{{--        <p>{!! $info['product_info']['content'] or '' !!}</p>--}}
        <p>吊牌价{{ $info['activity_info']['tag_price'] or '0.00' }}</p>
        <p>商品价{{ $info['activity_info']['price'] or '0.00' }}</p>
        <p>快递费{{ $info['activity_info']['freight_price'] or '0.00' }}</p>
        <p>保价费{{ $info['activity_info']['insured_price'] or '0.00' }}</p>
  <form class="am-form am-form-horizontal" method="post"  id="addForm">
    ...
    <input type="text" name="addr" value="" lay-verify="required" placeholder="请输入详细地址" autocomplete="off" class="layui-input">
        ...
        <p>合计支付{{ $info['activity_info']['pay_price'] or '0.00' }}元</p>
    <input type="button"  id="submitBtn" lay-submit="" lay-filter="layuiadmin-app-form-submit" value="支付领取" class="layui-btn layui-btn-normal">
  </div>
  </form>
