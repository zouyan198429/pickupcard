...
<div class="wrap">
  ...
  <div class="propic">
    <img src="{{asset('web/images/p3/p301.jpg')}}" alt="">
    <img src="{{asset('web/images/p3/p302.jpg')}}" alt="">
    <img src="{{asset('web/images/p3/p303.jpg')}}" alt="">
    <img src="{{asset('web/images/p3/p304.jpg')}}" alt="">
  </div>
  <div class="probtnbox">
